...
LABEL=com.research-report.loop-memory.maintenance
AGENT_FILE="$HOME/Library/LaunchAgents/$LABEL.plist"
LOG_DIR="$HOME/.research-report-memory-v2-0821/maintenance-logs"
...
echo "已启用每天 16:30 的 Report Memory Dreaming：$AGENT_FILE"
