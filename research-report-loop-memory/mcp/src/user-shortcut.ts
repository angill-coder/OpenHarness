...
export const USER_SHORTCUT_NAME = "Research Report Memory V2-0821";

function usesDefaultDataDir(dataDir: string): boolean {
  return path.resolve(dataDir) === path.resolve(path.join(os.homedir(), ".research-report-memory-v2-0821"));
}
