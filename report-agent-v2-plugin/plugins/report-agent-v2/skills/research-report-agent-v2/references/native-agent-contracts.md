...
| `report-writer-v2` | mode + 用户确认与素材 + dataVersion/dataSha256 + 写作指令 + target path；改写另加指定基线、plan、revisionBrief | `REPORT_WRITE_COMPLETED` | draft/revise 写内部候选 RN，feedback 写交付版 vN，均不覆盖已有稿 |
