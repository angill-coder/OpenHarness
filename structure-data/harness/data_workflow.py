#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Standalone workflow API and CLI for structured data and quality auditing.

The public surface intentionally lives in this one module.  The sizeable
audit implementation remains private. Dataset construction is intentionally
not included in this standalone distribution.
"""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="OpenHarness 结构化论据清洗与质检 workflow"
    )
