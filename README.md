...
- `plugins/report-loop/`: standalone Report Loop application, including its web UI, orchestration service, Judge/scoring logic, WorkBuddy runner, rubric, report Skill, tests, and runtime documentation.
